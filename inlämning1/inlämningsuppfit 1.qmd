...
![](Skärmbild 2025-02-03 112829.png)
...
Visualisera förändringen i åldersfördelning i den svenska befolkningen under perioden 1860-
2023 med ggplot och datamaterialet population_1860_2023. Ni väljer själva hur ni på ett
bra sätt ska visualisera utvecklingen.
...
upp3 <- ggplot(data = upp3data,
               aes(x=as.numeric(year),
                   ...
                   fill = age))+
  geom_col()+
  labs(title = "Åldersfördelning i Sverige 1826 - 2023",
       x = "År",
